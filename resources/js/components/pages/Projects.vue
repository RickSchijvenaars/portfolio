<template>
    <div class="justify-content-center">
        ...
        <div class="row content-margin">
            <router-link :to="{ name: 'project', params: { title: project.title, project: project }}" v-for="project in orderedProjects" :key="project.id" class="col-sm-6 col-md-4 col-xl-3 p-0">
...
export default {
    ...
    computed: {
        orderedProjects() {
            return _.orderBy(this.projects, 'created_at', 'desc'); 
        }
    },
    mounted() {
        this.loadProjects();
